...
public:
     ...
     */
    static double getAccruedPowerConsumption(const Model& model, const Configuration& configuration, const Environment& environment, const Observations& observations);
};
